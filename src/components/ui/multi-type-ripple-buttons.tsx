import React, { useState, useMemo, type ReactNode, type MouseEvent, type CSSProperties } from 'react';
...
const RippleButton: React.FC<RippleButtonProps> = ({
  ...
  rippleDuration = 600,
  hoverBaseColor = '#D4AF37', // Adjusted for NAI Gold Theme
  hoverRippleColor: customHoverRippleColor,
  hoverBorderEffectColor = '#D4AF3777', // Adjusted for NAI Gold Theme
  ...
  const determinedJsRippleColor = useMemo(() => {
    ...
    return 'var(--button-ripple-color, rgba(212, 175, 55, 0.2))';
  ...
  // Default variant
  const baseClasses = "relative border-none overflow-hidden isolate transition-all duration-200 cursor-pointer px-4 py-2 bg-brand-gold hover:opacity-90 text-black rounded-lg font-bold";
